...
export const CLUSTER_COORDINATES: Record<string, { lat: number; lng: number }> = {
  ...
  'Apuoyo': { lat: -1.2638, lng: 36.7024 },        // Kiambu / Nairobi border
  'Sibembe': { lat: 0.84019, lng: 34.86705 },      // Sikhendu, Trans-Nzoia County
  'Hope': { lat: -1.3323, lng: 36.8837 },         // Nairobi
  'Wages': { lat: -1.2584, lng: 36.8172 },        // Nairobi
  'Red Hill': { lat: -1.2183, lng: 36.7214 },     // Kiambu
  'Ligega': { lat: 0.1583, lng: 34.2583 },        // Siaya
  'Utoma Widows Food coop': { lat: 0.1250, lng: 34.3333 }, // Siaya
  'New Grassroots Food Coop': { lat: -1.2867, lng: 36.8172 }, // Nairobi
  'New Kangemi Food Coop': { lat: -1.2693, lng: 36.7442 }
};
