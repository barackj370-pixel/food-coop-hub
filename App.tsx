          ...
          <div className="space-y-12 animate-in fade-in slide-in-from-bottom-4 duration-500">
            ...
            <div className="space-y-4">
              ...
              <div className="flex justify-center">
                <button 
                  onClick={() => setCurrentPortal('COOP_RANKING')}
                  className="bg-emerald-50 text-emerald-600 hover:bg-emerald-600 hover:text-white px-8 py-3 rounded-2xl font-black text-[10px] uppercase tracking-widest transition-all shadow-sm"
                >
                  View Full Food Coops Ranking
                </button>
              </div>
            </div>
