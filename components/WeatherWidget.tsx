  ...
  return (
    <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="bg-gradient-to-br from-blue-500 to-blue-700 rounded-[2.5rem] p-10 text-white shadow-2xl relative overflow-hidden">
        ...
        {/* Advisory Card */}
        <div className="bg-white rounded-[2.5rem] p-10 border border-slate-200 shadow-xl flex flex-col justify-center relative overflow-hidden">
