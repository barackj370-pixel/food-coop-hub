...
const FarmForms: React.FC<FarmFormsProps> = ({ agentCluster, dynamicClusters }) => {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      alert('Form submitted successfully! GPS location captured for verification.');
      form.reset();
    } catch (error) {
                  ...
                  {['Ploughing', 'Planting', 'Weeding', 'Harvesting', 'Slashing', 'Washing', 'Sweeping', 'Fetching water', 'Watering crops', 'Feeding animals', 'Other'].map(work => (
                    <label key={work} className="flex items-center space-x-3 cursor-pointer group">
                      <div className="relative flex items-center justify-center">
                        <input type="checkbox" name="workDone" value={work} className="peer sr-only" />
            ...
            <div className="space-y-8 animate-in fade-in duration-300">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-2">
                  ...
                  <input type="text" name="productionOfficerName" required placeholder="Enter officer name" className="w-full bg-slate-50 border border-slate-200 rounded-2xl px-6 py-4 font-bold text-slate-700 outline-none focus:bg-white focus:border-emerald-400 transition-all" />
                </div>
                <div className="space-y-2">
                  ...
                  <input type="text" name="productionOfficerContact" required placeholder="Enter officer contact" className="w-full bg-slate-50 border border-slate-200 rounded-2xl px-6 py-4 font-bold text-slate-700 outline-none focus:bg-white focus:border-emerald-400 transition-all" />
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div className="space-y-2">
                  <label className="text-[10px] font-black text-slate-400 uppercase tracking-widest ml-2">Name of Homestead Visited</label>
                  <input type="text" name="homesteadVisitedName" required placeholder="Enter homestead name" className="w-full bg-slate-50 border border-slate-200 rounded-2xl px-6 py-4 font-bold text-slate-700 outline-none focus:bg-white focus:border-emerald-400 transition-all" />
                </div>
                <div className="space-y-2">
                  <label className="text-[10px] font-black text-slate-400 uppercase tracking-widest ml-2">Name of Homestead Convener</label>
                  <input type="text" name="convenerName" required placeholder="Enter convener name" className="w-full bg-slate-50 border border-slate-200 rounded-2xl px-6 py-4 font-bold text-slate-700 outline-none focus:bg-white focus:border-emerald-400 transition-all" />
                </div>
                <div className="space-y-2">
                  <label className="text-[10px] font-black text-slate-400 uppercase tracking-widest ml-2">Contact of Homestead Convener</label>
                  <input type="text" name="convenerContact" required placeholder="Enter convener contact" className="w-full bg-slate-50 border border-slate-200 rounded-2xl px-6 py-4 font-bold text-slate-700 outline-none focus:bg-white focus:border-emerald-400 transition-all" />
                </div>
              </div>
              ...
              <div className="space-y-2">
                ...
                <input type="number" name="totalParticipants" min="1" required placeholder="e.g. 5" className="w-full md:w-1/3 bg-slate-50 border border-slate-200 rounded-2xl px-6 py-4 font-bold text-slate-700 outline-none focus:bg-white focus:border-emerald-400 transition-all" />
              </div>
              ...
              <div className="space-y-6 pt-6 border-t border-slate-100">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="space-y-2">
                    ...
                    <textarea name="soilTypes" rows={3} required placeholder="List soil types..." className="w-full bg-slate-50 border border-slate-200 rounded-2xl px-6 py-4 font-bold text-slate-700 outline-none focus:bg-white focus:border-emerald-400 transition-all resize-none"></textarea>
                  </div>
                  <div className="space-y-2">
                    <label className="text-[10px] font-black text-slate-400 uppercase tracking-widest ml-2">Source of Water</label>
                    <textarea name="waterSource" rows={3} required placeholder="List water sources..." className="w-full bg-slate-50 border border-slate-200 rounded-2xl px-6 py-4 font-bold text-slate-700 outline-none focus:bg-white focus:border-emerald-400 transition-all resize-none"></textarea>
                  </div>
                  <div className="space-y-2">
                    <label className="text-[10px] font-black text-slate-400 uppercase tracking-widest ml-2">Types of Farm Inputs & Sources</label>
                    <textarea name="farmInputs" rows={3} required placeholder="List inputs and their sources..." className="w-full bg-slate-50 border border-slate-200 rounded-2xl px-6 py-4 font-bold text-slate-700 outline-none focus:bg-white focus:border-emerald-400 transition-all resize-none"></textarea>
                  </div>
                  <div className="space-y-2">
                    <label className="text-[10px] font-black text-slate-400 uppercase tracking-widest ml-2">Types of Waste Produced</label>
                    <textarea name="wasteTypes" rows={3} required placeholder="List waste types..." className="w-full bg-slate-50 border border-slate-200 rounded-2xl px-6 py-4 font-bold text-slate-700 outline-none focus:bg-white focus:border-emerald-400 transition-all resize-none"></textarea>
                  </div>
                  <div className="space-y-2">
                    <label className="text-[10px] font-black text-slate-400 uppercase tracking-widest ml-2">How do you handle the waste?</label>
                    <textarea name="wasteHandling" rows={3} required placeholder="Describe waste handling..." className="w-full bg-slate-50 border border-slate-200 rounded-2xl px-6 py-4 font-bold text-slate-700 outline-none focus:bg-white focus:border-emerald-400 transition-all resize-none"></textarea>
                  </div>
                  <div className="space-y-2">
                    ...
                    <textarea name="productsToSupply" rows={3} required placeholder="List farm food, processed food, or non-food products..." className="w-full bg-slate-50 border border-slate-200 rounded-2xl px-6 py-4 font-bold text-slate-700 outline-none focus:bg-white focus:border-emerald-400 transition-all resize-none"></textarea>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-8 animate-in fade-in duration-300">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-2">
                  ...
                  <input type="text" name="homesteadName" required placeholder="Enter household or homestead name" className="w-full bg-slate-50 border border-slate-200 rounded-2xl px-6 py-4 font-bold text-slate-700 outline-none focus:bg-white focus:border-emerald-400 transition-all" />
                </div>
                <div className="space-y-2">
                  <label className="text-[10px] font-black text-slate-400 uppercase tracking-widest ml-2">Household/Homestead Contact</label>
                  <input type="text" name="homesteadContact" required placeholder="Enter contact number or email" className="w-full bg-slate-50 border border-slate-200 rounded-2xl px-6 py-4 font-bold text-slate-700 outline-none focus:bg-white focus:border-emerald-400 transition-all" />
                </div>
              </div>
              ...
              <div className="space-y-6 pt-6 border-t border-slate-100">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="space-y-2">
                    ...
                    <textarea name="cropsGrown" rows={3} required placeholder="List crops grown..." className="w-full bg-slate-50 border border-slate-200 rounded-2xl px-6 py-4 font-bold text-slate-700 outline-none focus:bg-white focus:border-emerald-400 transition-all resize-none"></textarea>
                  </div>
                  <div className="space-y-2">
                    ...
                    <textarea name="livestockKept" rows={3} required placeholder="List livestock kept..." className="w-full bg-slate-50 border border-slate-200 rounded-2xl px-6 py-4 font-bold text-slate-700 outline-none focus:bg-white focus:border-emerald-400 transition-all resize-none"></textarea>
                  </div>
                </div>
              </div>
              ...
              <div className="space-y-6 pt-6 border-t border-slate-100">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="space-y-2">
                    ...
                    <textarea name="weeklyActivities" rows={3} required placeholder="List weekly activities..." className="w-full bg-slate-50 border border-slate-200 rounded-2xl px-6 py-4 font-bold text-slate-700 outline-none focus:bg-white focus:border-emerald-400 transition-all resize-none"></textarea>
                  </div>
                  <div className="space-y-2">
                    ...
                    <textarea name="challengesFaced" rows={3} required placeholder="List challenges faced..." className="w-full bg-slate-50 border border-slate-200 rounded-2xl px-6 py-4 font-bold text-slate-700 outline-none focus:bg-white focus:border-emerald-400 transition-all resize-none"></textarea>
                  </div>
                </div>
              </div>
              ...
              <div className="space-y-6 pt-6 border-t border-slate-100">
                ...
                <div className="space-y-6">
                  <div className="space-y-2">
                    ...
                    <textarea name="foodConsumed" rows={3} required placeholder="List products consumed daily..." className="w-full bg-slate-50 border border-slate-200 rounded-2xl px-6 py-4 font-bold text-slate-700 outline-none focus:bg-white focus:border-emerald-400 transition-all resize-none"></textarea>
                  </div>
                  <div className="space-y-2">
                    ...
                    <textarea name="amountSpent" rows={3} required placeholder="State average amount spent..." className="w-full bg-slate-50 border border-slate-200 rounded-2xl px-6 py-4 font-bold text-slate-700 outline-none focus:bg-white focus:border-emerald-400 transition-all resize-none"></textarea>
                  </div>
                  <div className="space-y-2">
                    ...
                    <textarea name="foodSource" rows={3} required placeholder="State source of products..." className="w-full bg-slate-50 border border-slate-200 rounded-2xl px-6 py-4 font-bold text-slate-700 outline-none focus:bg-white focus:border-emerald-400 transition-all resize-none"></textarea>
                  </div>
                  <div className="space-y-2">
                    ...
                    <textarea name="productsNeeded" rows={3} required placeholder="List products needed for supply..." className="w-full bg-slate-50 border border-slate-200 rounded-2xl px-6 py-4 font-bold text-slate-700 outline-none focus:bg-white focus:border-emerald-400 transition-all resize-none"></textarea>
                  </div>
                </div>
              </div>
              ...
              <div className="space-y-6 pt-6 border-t border-slate-100">
                ...
                <div className="space-y-2">
                  ...
                  <textarea name="harvestedProducts" rows={4} required placeholder="List varieties, quantities and value..." className="w-full bg-slate-50 border border-slate-200 rounded-2xl px-6 py-4 font-bold text-slate-700 outline-none focus:bg-white focus:border-emerald-400 transition-all resize-none"></textarea>
                </div>
              </div>
              ...
              <div className="space-y-6 pt-6 border-t border-slate-100">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="space-y-2">
                    ...
                    <textarea name="soilErosion" rows={3} required placeholder="List types of soil erosion..." className="w-full bg-slate-50 border border-slate-200 rounded-2xl px-6 py-4 font-bold text-slate-700 outline-none focus:bg-white focus:border-emerald-400 transition-all resize-none"></textarea>
                  </div>
                  <div className="space-y-2">
                    ...
                    <textarea name="erosionStrategies" rows={3} required placeholder="List strategies for curbing erosion..." className="w-full bg-slate-50 border border-slate-200 rounded-2xl px-6 py-4 font-bold text-slate-700 outline-none focus:bg-white focus:border-emerald-400 transition-all resize-none"></textarea>
                  </div>
                </div>
              </div>
            </div>
